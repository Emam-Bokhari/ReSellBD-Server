...
const createTransactionController = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { createdOrder, paymentUrl } = yield transaction_service_1.TransactionServices.createTransaction(transactionPayload, identifier);
...
const updateTransactionStatusByIdController = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedStatus = yield transaction_service_1.TransactionServices.updateTransactionStatusById(id, status, identifier);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
...
const getPurchasesHistoryBySpecificUserController = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { identifier } = req.user;
    const query = req.query;
    const purchasesHistory = yield transaction_service_1.TransactionServices.getPurchasesHistoryBySpecificUser(identifier, query);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
...
const getSalesHistoryBySpecificUserController = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { identifier } = req.user;
    const query = req.query;
    const salesHistory = yield transaction_service_1.TransactionServices.getSalesHistoryBySpecificUser(identifier, query);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
